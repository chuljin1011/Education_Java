...
public class StringApp {
	public static void main(String[] args) {
		...
		System.out.println("문자열의 문자 갯수 = " + str5.indexOf('A'));
		System.out.println("문자열의 문자 갯수 = " + str5.indexOf("EFG"));
		System.out.println("==============================================================");
		...
		System.out.println(str9.substring(1));
		System.out.println(str9.substring(0,3));
		
		System.out.println(1 + 1.0+ "가"+1+1.0);
	}
}

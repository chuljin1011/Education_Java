...
public class ListApp {
	public static void main(String[] args) {
		...
		if (list.contains("홍길동")) {
			System.out.println("List 객체에 저장된 요소값 입니다.");
		} else {
		...
		if (list.isEmpty()) {
			System.out.println("list에 값이 존재 하지 않습니다.");
		} else {
			System.out.println("list에 값이 " + list.size() + "개 존재 합니다.");

		}
		System.out.println("===================");
		List<Integer> memberList = Arrays.asList(10, 20, 30, 40, 50);

		System.out.println(memberList);

		System.out.println("===================");
		List<String> strList = Arrays.asList("1", "2", "3", "가", "나");

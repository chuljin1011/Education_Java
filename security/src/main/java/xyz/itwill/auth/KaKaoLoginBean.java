...
public class KaKaoLoginBean {
	...
	private final static String KAKAO_CLIENT_ID="6f8d4741782291f82fa3bef03edae933";
	//Kakao Developers의 애플리케이션에서 발급받은 [Client Secret]를 저장
	private final static String KAKAO_CLIENT_SECRET="8Ad939XieWOg0IYcaD9DWJtjgQARDipM";

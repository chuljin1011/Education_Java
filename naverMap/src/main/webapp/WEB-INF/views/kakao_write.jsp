...
<!-- 장소명, 위도, 경도를 표시할 div -->
<div id="placeInfo">
    <span id="placeName">장소명: </span>
    <span id="latitude">위도: </span>
    <span id="longitude">경도: </span>
</div>
    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        (function(marker, title, lat, lng) {
            ...
            itemEl.onclick = function() {
                document.getElementById('placeName').innerText = '장소명: ' + title;
                document.getElementById('latitude').innerText = '위도: ' + lat;
                document.getElementById('longitude').innerText = '경도: ' + lng;
            };

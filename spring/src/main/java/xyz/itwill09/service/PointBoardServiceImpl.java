...
public class PointBoardServiceImpl implements PointBoardService{
	...
	//매개변수로 게시글을 전달받아 POINT_BOARD 테이블의 행으로 삽입하고 게시글 작성자에 대한
	//회원정보 POINT_USER 테이블에서 검색하여 회원정보를 반환하는 메소드
	...
	//매개변수로 글번호를 전달받아 POINT_BOARD 테이블의 행으로 삭제하고 삭제된 게시글의 작성자에 
	//대한 회원정보 POINT_USER 테이블에서 검색하여 회원정보를 반환하는 메소드

...
public class Pager {
	...
	//생성자로 초기화된 필드값들을 사용해 계산 결과값을 필드에 저장
	private int totalPage;//전체 페이지의 갯수
	private int startRow;//요청 페이지에 출력될 게시글의 시작 행번호
	private int endRow;//요청 페이지에 출력될 게시글의 종료 행번호
	private int startPage;//현재의 블럭에 출력될 시작 페이지 번호
	private int endPage;//현재의 블럭에 출력될 종료 페이지 번호
	private int prevPage;//이전 블럭에 출력될 종료 페이지 번호
	private int nextPage;//다음 블럭에 출력될 종료 페이지 번호
